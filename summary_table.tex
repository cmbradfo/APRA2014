...
\hline
Temperature & \multicolumn{5}{l}{250K} \\
Used diameter & \multicolumn{5}{l}{2.4~m (primary mirror is pupil stopped)}\\
Emissivity & \multicolumn{5}{l}{0.01} \\
Primary $f/\#$ & \multicolumn{5}{l}{1.25} \\
Gregorian $f/\#$ & \multicolumn{5}{l}{5} \\
Available FOV & \multicolumn{5}{l}{29\arcmin $\times$ 29\arcmin} \\
\hline
\multicolumn{6}{l}{\bf Detectors} \\
\hline
TiN \Tc & \multicolumn{5}{l}{0.9 K} \\
Base temperature & \multicolumn{5}{l}{150 mK} \\
...
\icaris\ pixel response & \multicolumn{5}{l}{$4\times10^{8}$ $(\delta f/f)\,\rm W^{-1}$, scaled from MAKO as (volume)$^{-1}$ and \Tc$^{-2}$}\\
\Sxx (due to TLS) & \multicolumn{5}{l}{$1.0\times10^{-18}$ $(\delta f/f)^2\,\rm Hz^{-1}$, same as MAKO}\\
Detector efficiency w/ lens & \multicolumn{5}{l}{$>$70\%} \\ 
